...
internal class EvaluatorTest{
    ...
    fun trueEyeOnTheCorner(){
        ...
        Assertions.assertTrue(Evaluator.isAnEye(board, Point.of(1, 1), Player.BLACK))
        Assertions.assertFalse(Evaluator.isAnEye(board, Point.of(1, 1), Player.WHITE))
    ...
    fun notAnEyeOnTheBorder(){
        ...
        board.placeStone(Player.BLACK, Point.of(4, 2))
    ...
    fun trueEyesWithSingleStone(){
        ...
        board.placeStone(Player.WHITE, Point.of(2, 3))
        board.placeStone(Player.WHITE, Point.of(2, 4))
        board.placeStone(Player.WHITE, Point.of(2, 5))

        board.placeStone(Player.WHITE, Point.of(3, 2))
        board.placeStone(Player.BLACK, Point.of(3, 3))
        board.placeStone(Player.BLACK, Point.of(3, 4))
        board.placeStone(Player.BLACK, Point.of(3, 5))
        board.placeStone(Player.WHITE, Point.of(3, 6))
        board.placeStone(Player.WHITE, Point.of(3, 7))

        board.placeStone(Player.WHITE, Point.of(4, 2))
        board.placeStone(Player.BLACK, Point.of(4, 3))
        board.placeStone(Player.BLACK, Point.of(4, 5))
        board.placeStone(Player.BLACK, Point.of(4, 6))
        board.placeStone(Player.WHITE, Point.of(4, 7))

        board.placeStone(Player.WHITE, Point.of(5, 2))
        board.placeStone(Player.WHITE, Point.of(5, 3))
        board.placeStone(Player.BLACK, Point.of(5, 4))
        board.placeStone(Player.BLACK, Point.of(5, 6))
        board.placeStone(Player.WHITE, Point.of(5, 7))

        board.placeStone(Player.WHITE, Point.of(6, 3))
        board.placeStone(Player.WHITE, Point.of(6, 4))
        board.placeStone(Player.BLACK, Point.of(6, 5))
        board.placeStone(Player.BLACK, Point.of(6, 6))
        board.placeStone(Player.WHITE, Point.of(6, 7))

        board.placeStone(Player.WHITE, Point.of(7, 4))
        board.placeStone(Player.WHITE, Point.of(7, 5))
        board.placeStone(Player.WHITE, Point.of(7, 6))
        board.placeStone(Player.WHITE, Point.of(7, 7))
